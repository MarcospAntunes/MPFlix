...
export async function getTrendingMovieData(type: string, setMovieTrendingData: any): Promise<void> {
    try {
        const response = await axios.get(`https://api.themoviedb.org/3/trending/${type}/day?api_key=${api_key}&media_type=movie`)
...
export async function getDiscoverMovieData(type: string, setMovieDiscoverData: any): Promise<void> {
    try {
        const response = await axios.get(`https://api.themoviedb.org/3/discover/${type}?api_key=${api_key}`)
...
export async function getNowPlayingMovieData(type: string, setNowPlayingMovieData: any): Promise<void> {
    try {
        const response = await axios.get(`https://api.themoviedb.org/3/${type}/now_playing?api_key=${api_key}`)
...
export async function getVideosMovieData(type: string, setVideosMovieData: any, movie_id: number): Promise<void> {
    try {
        const response = await axios.get(`https://api.themoviedb.org/3/${type}/${movie_id}/videos?api_key=${api_key}`)
